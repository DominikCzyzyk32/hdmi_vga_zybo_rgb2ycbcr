...
#
# Generated by export_simulation on Thu Apr 07 09:45:08 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './LUT_b.sh' script.
...
./LUT_b.sh -noclean_files

For more information on the script, please type './LUT_b.sh -help'.
